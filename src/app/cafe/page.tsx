...
import { Coffee, Banknote, Smartphone, QrCode, Landmark, CreditCard } from "lucide-react";
            ...
            <div className="flex gap-2">
              {ALL_PAYMENT_OPTIONS.filter(opt => enabledPayments[opt.value]).map((opt) => (
                <button
                  ...
                  className={`flex flex-col items-center justify-center flex-1 py-2 px-3 rounded-lg text-xs font-medium transition-all border ${paymentMethod === opt.value
