                ...
                <div className="bg-gray-50/80 p-4 rounded-2xl border border-gray-200/60 shadow-sm transition-all duration-300 hover:shadow-md">
                  ...
                  <div className="flex gap-2 items-center max-w-lg">
                    <input
                      ...
                      className="flex-1 px-5 py-3.5 rounded-2xl border border-gray-200 text-lg font-bold text-gray-900 placeholder:text-gray-300 focus:outline-none focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500 bg-white transition-all shadow-sm"
                      maxLength={100}
                    />
                    <button
                      type="button"
